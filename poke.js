...
function clear (ElementT)     { 
                                ElementT.innerHTML = "";  };
    // returns an empty question field for populating with new question 



// calls a function that takes makes an API request 
...
request.addEventListener("submit", (e) => {
                                            ...
                                            // stores the input as      key : value     pairs

                                            // const myList = port(pokemon);
